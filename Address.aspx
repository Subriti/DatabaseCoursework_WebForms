...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <center>
            ...
            <asp:Button Text="Add Address" ID="modal" CssClass="btn btn-primary" OnClick="modal_Click" runat="server" CausesValidation="false"/>
            <div>
                <br />
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:TextBox ID="txtname" CssClass="form-control" placeholder="Address" runat="server" />
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=" Address cannot be empty" ControlToValidate="txtname" CssClass="text-danger" ForeColor="Red"></asp:RequiredFieldValidator>
