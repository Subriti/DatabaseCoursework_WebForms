...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!--<link href="https://cdn.syncfusion.com/ej2/material.css" rel="stylesheet" />
        ...
        //basic but works
        <asp:GridView ID="empTable1" runat="server" BorderStyle="Dashed" HeaderStyle-BackColor="Thistle" BorderWidth="2" DataKeyNames="EMPLOYEE_ID" OnRowDataBound="OnRowDataBound" OnRowEditing="OnRowEditing" OnRowCancelingEdit="OnRowCancelingEdit"  OnRowDeleting="OnRowDeleting" EmptyDataText="No records has been added." AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" />
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:TextBox ID="txtdob" CssClass="form-control" placeholder="Date of Birth (01-Jan-23)" runat="server" />
                        <br />
