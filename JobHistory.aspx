...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <center>
            ...
            <asp:Button Text="Add Job Detail" ID="modal" CssClass="btn btn-primary" OnClick="modal_Click" runat="server" CausesValidation="false" />
            <div>
                <br />
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add New Job Detail
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=" Start Date cannot be empty" ControlToValidate="txtstartdate"
                                CssClass="text-danger textAlign" ForeColor="Red"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtstartdate" ErrorMessage="Please enter a valid date."
                                ValueToCompare="dd-MMM-yy" CssClass="textAlign" ForeColor="Red" OnServerValidate="dateValidator_ServerValidate"></asp:CompareValidator>
                        </div>
                        <div class="form-group">
                            <label>End Date</label>
                            <asp:TextBox ID="txtenddate" CssClass="form-control" placeholder="End Date (02-Jul-23)" runat="server" />
                            <asp:CompareValidator ID="CompareValidator2" runat="server" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtenddate" ErrorMessage="Please enter a valid date." ValueToCompare="dd-MMM-yy" ForeColor="Red" OnServerValidate="dateValidator_ServerValidate"></asp:CompareValidator>
